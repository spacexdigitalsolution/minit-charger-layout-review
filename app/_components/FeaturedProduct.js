        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="fp-text lg:order-2 mb-12 lg:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/products/momentus" className="inline-flex items-center justify-center rounded-none bg-green-600 px-8 py-4 text-sm font-bold text-white hover:bg-green-700 transition-colors uppercase tracking-wider">
                Explore Momentus
              </Link>
              <Link href="/contact" className="inline-flex items-center justify-center rounded-none bg-transparent border border-zinc-900 dark:border-white px-8 py-4 text-sm font-bold text-zinc-900 dark:text-white hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors uppercase tracking-wider">
                Request Specs
              </Link>
            </div>
          </div>
