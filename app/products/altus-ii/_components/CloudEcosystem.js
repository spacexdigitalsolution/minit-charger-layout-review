      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="ce-item bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 p-8 rounded-lg flex flex-col items-center text-center">
            ...
            <h3 className="font-display font-bold text-2xl text-zinc-900 dark:text-white mb-3 uppercase ">AssetPro Integration</h3>
          ...
          <div className="ce-item bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 p-8 rounded-lg flex flex-col items-center text-center">
            ...
            <h3 className="font-display font-bold text-2xl text-zinc-900 dark:text-white mb-3 uppercase ">CellTrac Synergy</h3>
          ...
          <div className="ce-item bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 p-8 rounded-lg flex flex-col items-center text-center">
            ...
            <h3 className="font-display font-bold text-2xl text-zinc-900 dark:text-white mb-3 uppercase ">Automated Reporting</h3>
