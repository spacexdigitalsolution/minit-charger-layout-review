      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-4 mb-16 lg:mb-0 lg:sticky lg:top-40">
            <h1 className="font-display text-5xl md:text-6xl font-black tracking-tighter uppercase text-zinc-900 dark:text-white mb-6 leading-none">
              Contact Us
            </h1>
            <p className="text-xl text-zinc-600 dark:text-zinc-400 font-light leading-relaxed mb-12">
            ...
            <div className="border-t border-zinc-200 dark:border-zinc-800 pt-8 hidden lg:block">
              <h2 className="text-xs font-bold text-zinc-900 dark:text-white uppercase tracking-widest mb-6">
                Direct Contact
              </h2>
              
              <div className="space-y-8">
                <div>
                  <h3 className="text-sm font-bold text-zinc-600 dark:text-zinc-400 uppercase tracking-widest mb-2">Sales Inquiries</h3>
                ...
                <div>
                  <h3 className="text-sm font-bold text-zinc-600 dark:text-zinc-400 uppercase tracking-widest mb-2">Technical Support</h3>
                  <p className="font-medium">
                ...
                <div>
                  <h3 className="text-sm font-bold text-zinc-600 dark:text-zinc-400 uppercase tracking-widest mb-2">Global Headquarters</h3>
