  ...
  return (
    <div ref={containerRef} className="relative min-h-screen w-full bg-zinc-50 flex flex-col items-center justify-center overflow-hidden py-24">
      ...
      <div className="absolute top-4 left-4 z-50 pointer-events-none">
        ...
        <p className="text-zinc-600 text-[10px] mt-1 ml-1 uppercase tracking-widest">Sequential diagram draw</p>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="v3-header text-center mb-12">
          ...
          <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-black tracking-tighter text-zinc-900 uppercase mb-4 leading-[1.1] max-w-3xl mx-auto">
        ...
        <div className="relative w-full max-w-5xl mx-auto aspect-video md:aspect-[21/9] flex items-center justify-center my-12">
          ...
          <div className="absolute top-[30%] left-[10%] md:left-[20%] flex items-center">
            <div className="v3-label bg-white border border-zinc-200 shadow-sm px-3 py-2 rounded-sm z-10 text-right">
              <p className="font-display font-bold text-lg text-zinc-900 leading-none">40 kW</p>
              <p className="text-[10px] uppercase tracking-widest text-zinc-500 font-bold mt-1">Output</p>
            </div>
          ...
          <div className="absolute top-[40%] right-[10%] md:right-[20%] flex items-center flex-row-reverse">
            <div className="v3-label bg-white border border-zinc-200 shadow-sm px-3 py-2 rounded-sm z-10 text-left">
              <p className="font-display font-bold text-lg text-zinc-900 leading-none">Dual</p>
              <p className="text-[10px] uppercase tracking-widest text-zinc-500 font-bold mt-1">Connectors</p>
            </div>
          ...
          <div className="absolute bottom-[20%] left-[15%] md:left-[25%] flex items-center">
            <div className="v3-label bg-white border border-zinc-200 shadow-sm px-3 py-2 rounded-sm z-10 text-right">
              <p className="font-display font-bold text-lg text-zinc-900 leading-none">&gt; 94%</p>
              <p className="text-[10px] uppercase tracking-widest text-zinc-500 font-bold mt-1">Efficiency</p>
            </div>
