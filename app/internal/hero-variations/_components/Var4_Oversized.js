  ...
  return (
    <div ref={containerRef} className="relative min-h-screen w-full bg-zinc-950 flex flex-col items-center justify-center overflow-hidden py-24">
      ...
      <div className="absolute top-4 left-4 z-50 pointer-events-none">
        ...
        <p className="text-white/60 text-[10px] mt-1 ml-1 uppercase ">Word-by-word reveal</p>
      </div>
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center">
        ...
        <span className="v4-word inline-block text-xs md:text-sm font-bold text-green-500 uppercase  mb-8">
          Aviation GSE
        </span>

        <h1 className="font-display font-black  text-white uppercase  flex flex-col items-center">
        ...
        <div className="v4-cta mt-16">
          <button className="inline-flex items-center justify-center rounded border border-white px-10 py-5 text-sm font-bold text-white hover:bg-white hover:text-zinc-950 transition-colors uppercase  backdrop-blur-sm">
            Explore Solutions
          </button>
        </div>
