      ...
      <nav className={`fixed top-0 z-50 w-full transition-all duration-300 ${scrolled
        ...
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="hidden md:flex md:items-center md:gap-4">
            <Link href="/contact" className={`inline-flex h-10 items-center justify-center rounded-none px-6 py-2 text-sm font-bold uppercase tracking-wider transition-colors duration-300 ${scrolled
          ...
          <div className="flex md:hidden">
            <button onClick={() => setIsOpen(!isOpen)} className={`transition-colors duration-300 ${scrolled ? "text-zinc-600 hover:text-zinc-900 dark:text-zinc-300 dark:hover:text-white" : "text-white"}`}>
