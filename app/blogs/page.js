            ...
            <div className="flex flex-wrap justify-center gap-2">
              {categories.map((cat) => (
                <button
                  ...
                  className={`px-6 py-2 text-sm font-bold uppercase r rounded-sm transition-all duration-300 border ${activeCategory === cat
              ...
              <div className="flex flex-col lg:flex-row gap-8 mb-16 border-b border-zinc-200 dark:border-zinc-800 pb-16 blog-card">
                ...
                <div className="lg:w-1/3 flex flex-col justify-center py-4 pr-8">
                  ...
                  <Link href={`/blogs/${filteredBlogs[0].slug}`} className="group">
                    <h3 className="font-display text-4xl lg:text-5xl font-bold  text-zinc-900 dark:text-white group-hover:text-green-600 transition-colors mb-6 ">
                      {filteredBlogs[0].title}
                    </h3>
                  </Link>
                  <p className="text-zinc-600 dark:text-zinc-400 text-lg font-light  mb-8 line-clamp-3">
                    {filteredBlogs[0].excerpt}
                  </p>
                  <Link href={`/blogs/${filteredBlogs[0].slug}`} className="inline-flex items-center text-xs font-bold uppercase  text-zinc-900 dark:text-white hover:text-green-600 dark:hover:text-green-500 transition-colors">
